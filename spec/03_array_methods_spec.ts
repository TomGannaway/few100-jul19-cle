...
describe('Array Methods', () => {
    describe('examples', () => {
        ...
        describe('methods that produce a new array', () => {
            ...
            describe('methods that produce a single (salar) value', () => {
    ...
    describe('practical use', () => {
        ...
        it('second practice with data', () => {
            ...
            // produce an array of the names, email, phone of each active customer with a balance > 1,000.00
            interface Answer1 {
                name: string;
                email: string;
                phone: string;
            ...
            // 2. produce the total balance of all those people, and the number of people.
            interface Answer2 {
                totalBalance: number;
                count: number;
            }
            ...
            console.log("Just before answer1:");
            console.log(answer1);
